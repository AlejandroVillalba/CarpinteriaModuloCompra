      ...
      <div class="col-sm-6">
        <div class="form-group">
          <label class="label">Nombre de la Empresa</label>
            <input id="nameEmpresa" type="text" class="form-control @error('alpha') is-invalid @enderror"
            name="nombreEmpresa" value="{{ old('nombreEmpresa') }}" required maxlength="255"
            autocomplete="nombre" placeholder="Ingrese el nombre de la empresa" autofocus>
              @error('alpha')
      ...
      <div class="col-sm-6">
        <div class="form-group">
          <label class="label">Ruc</label>
            <input id="ruc" required unique maxlength="100" autocomplete="ruc" value="{{ old('ruc') }}"
              name="ruc" class="form-control @error('unique') is-invalid @enderror"
        ...
        <div class="form-group">
          <label class="label">Email</label>
            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"
              required  maxlength="50" autocomplete="email" placeholder="Ingrese su e-mail">
                  @error('email')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
